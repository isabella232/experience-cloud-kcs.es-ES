---
title: '''Adobe Campaign: Se produce un error de secuencia de comandos no definido al intentar ver el informe de clics activos'
...
# Adobe Campaign: Se produce un error de secuencia de comandos no definido al intentar ver el informe de clics activos

## Descripción


Se ha informado de que en 9032 G6 se está generando a veces un error de script no definido al intentar utilizar el informe de clics activos.
