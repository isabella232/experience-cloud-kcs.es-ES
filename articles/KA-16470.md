---
title: "Audience Manager a Campaign"
...
2. Sincronizar base de datos CRM con el cliente de Campaign debe configurar un proceso en el que inserte sus datos CRM en Campaign. El correo electrónico, CRM_ID son los campos mínimos que se deben sincronizar.
...
4. DTM lee la configuración CRM_ID en la herramienta &quot;servicio de Marketing Cloud ID&quot;. El elemento de datos hash_email está configurado en la DTM leyendo el CRM_ID disponible en dataLayer.
...
El SFTP creado para AAM debe configurarse con Adobe Campaign para que Campaign pueda insertar y extraer segmentos de AAM. El Servicio de atención al cliente de Adobe o su representante de Adobe le proporcionarán las credenciales de SFTP. Durante el aprovisionamiento, se aprovisionan tanto las ubicaciones de entrada como de salida de ftp, que la campaña utiliza para enviar audiencias a segmentos de AAM y a bordo de AAM a campaña respectivamente.
...
6. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; crear orígenes de datos y destinos con `~
...
A continuación, también capturamos el evento &quot;purchase&quot; en analytics en la página de agradecimiento:
...
En este punto, podemos hacer un seguimiento de nuestros clientes y crear segmentos en Audience Manager. Además, hemos garantizado que tanto el Audience Manager como Campaign recopilan a los usuarios con el mismo CRM_ID.

9. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; crear segmentos en función del comportamiento del usuario A continuación, cree los siguientes rasgos: &quot;Ha buscado invierno&quot;:
...
10. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Insertar el segmento en Campaña Para compartir una audiencia de AMC con una campaña, la configuración debe realizarse en Adobe Campaign una vez que el segmento se haya creado en~. Comience creando una audiencia compartida en Adobe Campaign y seleccione el segmento AMC de la lista de segmentos. Se deben crear dos audiencias compartidas basadas en MID y en el ID declarado dentro de la campaña. Una vez completada la configuración, los segmentos se pueden ver como asignados automáticamente a los destinos respectivos dentro de AAM.
...
11. Comparta una audiencia de campaña con AAM mediante AMC Para compartir una audiencia de campaña con AAM a través de AMC, se requiere la siguiente configuración dentro de Adobe Campaign. En la opción de menú Administración dentro de la interfaz de usuario de la campaña, seleccione flujos de trabajo técnicos de producción. Haga clic en los nuevos flujos de trabajo técnicos, arrastre la consulta y, a continuación, actualice la audiencia compartida y, a continuación, termine.
...
En campaign, cree primero una lista basada en una audiencia. Esto se encuentra en &quot;listas&quot;:
...
Es posible que no haya iniciado sesión con su Adobe ID para la campaña. Si ha iniciado sesión con su Adobe ID, asegúrese de que ha sido añadido al producto Biblioteca de audiencias en la interfaz de usuario de Marketing Cloud Enterprise Console.
...
3. Nunca asigne los segmentos al destino de la campaña desde la interfaz de usuario de AAM &#x200B;
