...
Ejemplo de configuración:    - loglevel = DEBUG - logfile = logs/activity.log - logger = org.apache.jackrabbit.vault.packaging.impl.ActivityLog

4. Instalación del Service Pack
5. Comprobar el registro de depuración
