...
<br>Durante la asignación/edición de un segmento de AEP en AAM, se produce el siguiente error:<br><br> <br><br>Hubo errores al intentar guardar el segmento.<br><br>Error del servicio de aplicación de directivas: UPSERT prohibido. La actualización dará como resultado una referencia de anclaje principal.<br>
