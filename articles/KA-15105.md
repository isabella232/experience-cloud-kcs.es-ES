---
title: Concepto de promoción de la marca en [!UICONTROL Envío de correo electrónico] y [!UICONTROL Página de aterrizaje]
...
# Concepto de promoción de la marca en [!UICONTROL Envío de correo electrónico] y [!UICONTROL Página de aterrizaje]

## Descripción

<br>Diferencia en el concepto de la configuración de Marca en [!UICONTROL Envío de correo electrónico] y [!UICONTROL Página de aterrizaje]
...
<b>Parámetros de configuración de marca en [!UICONTROL Página de aterrizaje]</b>


Asociación de una marca a una [!UICONTROL Página de aterrizaje] solo marcaría el nombre de la aplicación web/página de aterrizaje original. No hay direcciones URL dentro del origen de webapp/página de aterrizaje que tengan marca.
