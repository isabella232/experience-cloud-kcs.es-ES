...
El documento describirá las entradas de registro comunes que verá, lo que significan y cómo tratarlas.<br><br> <br><br>[Tabla de contenido](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17490.html)
...
Desde el módulo 4.2.x de Dispatcher, empezaron a desalentar a las personas para que usaran el siguiente tipo de coincidencias en su archivo de filtros:
...
Eso nos permite saber que nuestro archivo de diseño .eot está bloqueado y que querremos solucionarlo.
...
La página se obtuvo mediante el método http de GET para el contenido /content/we-retail/us/en.html y tardó 24034 milisegundos. La parte a la que queremos prestar atención es al final <b>publishfarm/0</b>. Verá que se ha dirigido a publishfarm y que coincide con él. La solicitud se obtuvo del render 0. Lo que significa que esta página tuvo que solicitarse desde AEM caché. Ahora vamos a solicitar esta página de nuevo y ver qué sucede con el registro.
